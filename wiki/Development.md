...
Every `internal/...` package is held to **100% statement coverage**. The `cmd/yupsh` entry point is the single os-wiring seam, excluded from coverage like the framework's own gate.
