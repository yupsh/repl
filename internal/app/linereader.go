...
// newline-delimited lines from a reader, with no terminal editing. It is a
// value-receiver handle around a pointer to the stateful bufio.Scanner, so
// copies share the one scanner.
